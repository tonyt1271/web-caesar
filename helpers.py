...
def rotate_character2(words,rot,direction):
    rot = rot*direction
...
def vigenere(string_1,key_word,direction):

    import string
    key_list = []
    for letter in key_word:
        key_list.append(alphabet_position2(letter))
    key_num = 0
    vig_string = []
    for character in string_1:
        if character.isalpha():
            key_val = key_list[key_num%len(key_word)]
            vig_string.append(rotate_character2(character, key_val,direction)[0])
            key_num += 1
        else:
            vig_string.append(character)
    a = "".join(vig_string)
    #print(a)
    return a
...
def alphabet_position2(letter):
    ...
    for index in range(26):
        letter_list_lower.append(string.ascii_lowercase[index])
        letter_list_upper.append(string.ascii_uppercase[index])
    if letter in letter_list_lower:
        letter_num = letter_list_lower.index(letter)
        return letter_num
    elif letter in letter_list_upper:
        letter_num = letter_list_upper.index(letter)
        return letter_num
    else:
        return letter
